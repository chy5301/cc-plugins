...
| **新增任务** | 发现缺少前置/后续工作 | `/plan-adjust 在<PREFIX>-XX后面加一个XX任务` |
| **删除任务** | 已被其他任务覆盖或不再需要 | `/plan-adjust 删除<PREFIX>-XX` |
| **修改任务** | 前序任务改变了后续任务的前提 | `/plan-adjust <PREFIX>-XX方案改为XX` |
| **重排序** | 依赖关系变化 | `/plan-adjust 调整<PREFIX>-XX和<PREFIX>-YY的顺序` |
