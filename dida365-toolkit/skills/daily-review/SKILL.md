...
name: daily-review
description: |
  滴答清单每日任务回顾与规划。当用户点名 "滴答清单""滴答""TickTick"，或本次对话已在操作滴答清单，并问"今天要做什么""任务概览""看看今天要做什么""有什么逾期的吗"时使用。按任意自定义条件筛选或统计任务请用 task-query。若用户还装有其他待办工具、本轮未指明平台且上下文无法确定，先向用户确认再执行。
version: 0.2.0
tools: Bash
---
